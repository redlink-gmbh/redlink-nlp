 ...
 */
public class TestLanguageSpanish {
    
    private static final Logger log = LoggerFactory.getLogger(TestLanguageSpanish.class);
    ...
    private static LanguageSpanish model;
    
    private OpenNlpPosProcessor processor;
    
    @BeforeClass
    public static void initClass() throws IOException{
        ClassLoader cl = TestLanguageSpanish.class.getClassLoader();
